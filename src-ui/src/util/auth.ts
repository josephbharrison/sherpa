export class ESIAuth {
    private clientId: string = 'bf22e6ad9225444c8e5a141150bdc1a7';
    private clientSecret: string = 'NwYwOYKLZnfrEvPvpd6FuCNTDXlIyWUTnBvQVTUi';
    private redirectUri: string = 'http://localhost:8383';
    ...
    public async getToken(authCode: string): Promise<string> {
        // Implement the logic to exchange authCode for JWT token using fetch or another HTTP library
        // Make use of this.clientSecret in this method to authenticate the request
        // You'd typically POST to the token endpoint of the ESI API with the necessary headers and body parameters

        return 'JWT_TOKEN'; // Replace with actual implementation
    }

    public async refreshToken(refreshToken: string): Promise<string> {
        // Implement the logic to refresh the JWT token using fetch or another HTTP library
        // Make use of this.clientSecret in this method to authenticate the request
        // You'd typically POST to the token refresh endpoint of the ESI API with the necessary headers and body parameters

        return 'NEW_JWT_TOKEN'; // Replace with actual implementation
    }

    public parseJWT(jwt: string): any {
        // Implement JWT parsing logic to extract necessary details like expiration time, etc.

        return {}; // Replace with actual implementation
    }

    public isTokenExpired(jwt: string): boolean {
        // Use this method to check if the JWT token has expired by parsing it and checking the expiration time
